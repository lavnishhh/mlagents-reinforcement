A unity project that uses reinforcement learning to create an agent that performs pick and drop in an well-obstacled environment using C# and mlagents library in the python environment.
